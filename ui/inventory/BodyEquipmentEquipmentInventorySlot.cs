...
using static Erebus.UI.InventoryWindow.InventoryWindow;
...
public partial class BodyEquipmentEquipmentInventorySlot : EquipmentItemSlot
{
    ...
    private InventoryWindow.InventoryWindow _inventoryWindow;
    ...
    public override void _Ready()
    {
        ...
        _inventoryWindow = GetOwner<Control>().GetNode<InventoryWindow.InventoryWindow>("../InventoryWindow/");
    ...
    protected override void OnItemInfoChanged(ItemInfo itemInfo)
    {
        ...
        if (itemInfo != null)
        {
            ...
            {
                _inventoryWindow.AddInventory(bodyEquipment, type);
            }
        }
        else
        {
            _inventoryWindow.RemoveInventoryGrid(type);
        }
    }
}
