...
public partial class LegsArmorEquipmentItemSlot : EquipmentItemSlot
{
    public override void _Ready()
    {
        ...
        Equip(LegsArmor.FromParameters("id", GD.Load<Texture2D>("res://art/ui/inventory_icons/Jeans_and_boots.png"), 2, 2, GD.Load<Texture2D>("res://art/player_equipment/pants/Jeans_and_boots.png")));
    }
